...
public class PhoneFragment extends Fragment {
    ...
    private void showProduct(){
        ...
        // rv Sản phẩm nổi bật
        spNoiBatAdapter = new RecyclerViewPhoneHighlightsAdapter(getContext(), list);
        ...
        // rv Linh kiện
        electronicAdapter = new RecyclerViewElectronicAdapter(getContext(), electronicList);
        rvLinhKien.setAdapter(electronicAdapter);
        // rv Phone
        phoneAdapter = new RecyclerViewPhoneAdapter(getContext(), list);
