...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        sProductAdapter= new SProductAdapter(getContext(), mListSProduct);
        ...
        mComponentAdapter = new ComponentAdapter(getContext(), mListComponent);
        ...
        mFeaturedAdapter = new FeaturedProductAdapter(getContext(), mListFeaturedProduct, mListComponent);
